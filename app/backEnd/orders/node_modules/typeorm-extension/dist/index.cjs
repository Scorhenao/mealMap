...
async function adjustFilePath(input, tsconfig) {
    if (isCodeTransformation(exports.CodeTransformation.JUST_IN_TIME)) {
        return input;
    }
    if (!locter.isObject(tsconfig)) {
...
exports.EnvironmentVariableName = void 0;
...
})(exports.EnvironmentVariableName || (exports.EnvironmentVariableName = {}));
...
function transformCache(input) {
    ...
    if (input === 'redis' || input === 'ioredis' || input === 'database' || input === 'ioredis/cluster') {
        ...
        const envCacheOptions = envix.oneOf([
            envix.read(exports.EnvironmentVariableName.CACHE_OPTIONS),
            envix.read(exports.EnvironmentVariableName.CACHE_OPTIONS_ALT)
        ]);
        if (envCacheOptions) {
        ...
        return {
            ...
            alwaysEnabled: envix.oneOf([
                envix.readBool(exports.EnvironmentVariableName.CACHE_ALWAYS_ENABLED),
                envix.readBool(exports.EnvironmentVariableName.CACHE_ALWAYS_ENABLED_ALT)
            ]),
            duration: envix.oneOf([
                envix.readInt(exports.EnvironmentVariableName.CACHE_DURATION),
                envix.readInt(exports.EnvironmentVariableName.CACHE_DURATION_ALT)
            ])
        };
    }
    return undefined;
...
function useEnv(key) {
    ...
    const output = {
        env: envix.read(exports.EnvironmentVariableName.ENV, exports.EnvironmentName.DEVELOPMENT),
        // Seeder
        seeds: envix.oneOf([
            envix.readArray(exports.EnvironmentVariableName.SEEDS),
            envix.readArray(exports.EnvironmentVariableName.SEEDS_ALT)
        ]) ?? [],
        factories: envix.oneOf([
            envix.readArray(exports.EnvironmentVariableName.FACTORIES),
            envix.readArray(exports.EnvironmentVariableName.FACTORIES_ALT)
        ]) ?? [],
        // Database
        url: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.URL),
            envix.read(exports.EnvironmentVariableName.URL_ALT)
        ]),
        host: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.HOST),
            envix.read(exports.EnvironmentVariableName.HOST_ALT)
        ]),
        port: envix.oneOf([
            envix.readInt(exports.EnvironmentVariableName.PORT),
            envix.readInt(exports.EnvironmentVariableName.PORT_ALT)
        ]),
        username: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.USERNAME),
            envix.read(exports.EnvironmentVariableName.USERNAME_ALT)
        ]),
        password: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.PASSWORD),
            envix.read(exports.EnvironmentVariableName.PASSWORD_ALT)
        ]),
        database: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.DATABASE),
            envix.read(exports.EnvironmentVariableName.DATABASE_ALT)
        ]),
        sid: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.SID),
            envix.read(exports.EnvironmentVariableName.SID_ALT)
        ]),
        schema: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.SCHEMA),
            envix.read(exports.EnvironmentVariableName.SCHEMA_ALT)
        ]),
        extra: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.DRIVER_EXTRA),
            envix.read(exports.EnvironmentVariableName.DRIVER_EXTRA_ALT)
        ]),
        synchronize: envix.oneOf([
            envix.readBool(exports.EnvironmentVariableName.SYNCHRONIZE),
            envix.readBool(exports.EnvironmentVariableName.SYNCHRONIZE_ALT)
        ]),
        schemaDrop: envix.oneOf([
            envix.readBool(exports.EnvironmentVariableName.SCHEMA_DROP),
            envix.readBool(exports.EnvironmentVariableName.SCHEMA_DROP_ALT)
        ]),
        migrationsRun: envix.oneOf([
            envix.readBool(exports.EnvironmentVariableName.MIGRATIONS_RUN),
            envix.readBool(exports.EnvironmentVariableName.MIGRATIONS_RUN_ALT)
        ]),
        entities: envix.oneOf([
            envix.readArray(exports.EnvironmentVariableName.ENTITIES),
            envix.readArray(exports.EnvironmentVariableName.ENTITIES_ALT)
        ]) ?? [],
        migrations: envix.oneOf([
            envix.readArray(exports.EnvironmentVariableName.MIGRATIONS),
            envix.readArray(exports.EnvironmentVariableName.MIGRATIONS_ALT)
        ]) ?? [],
        migrationsTableName: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.MIGRATIONS_TABLE_NAME),
            envix.read(exports.EnvironmentVariableName.MIGRATIONS_TABLE_NAME_ALT)
        ]),
        metadataTableName: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.METADATA_TABLE_NAME),
            envix.read(exports.EnvironmentVariableName.METADATA_TABLE_NAME_ALT)
        ]),
        subscribers: envix.oneOf([
            envix.readArray(exports.EnvironmentVariableName.SUBSCRIBERS),
            envix.readArray(exports.EnvironmentVariableName.SUBSCRIBERS_ALT)
        ]) ?? [],
        logging: transformLogging(envix.oneOf([
            envix.read(exports.EnvironmentVariableName.LOGGING),
            envix.read(exports.EnvironmentVariableName.LOGGING_ALT)
        ])),
        logger: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.LOGGER),
            envix.read(exports.EnvironmentVariableName.LOGGER_ALT)
        ]),
        entityPrefix: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.ENTITY_PREFIX),
            envix.read(exports.EnvironmentVariableName.ENTITY_PREFIX_ALT)
        ]),
        maxQueryExecutionTime: envix.oneOf([
            envix.readInt(exports.EnvironmentVariableName.MAX_QUERY_EXECUTION_TIME),
            envix.readInt(exports.EnvironmentVariableName.MAX_QUERY_EXECUTION_TIME_ALT)
        ]),
        debug: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.DEBUG),
            envix.read(exports.EnvironmentVariableName.DEBUG_ALT)
        ]),
        cache: transformCache(envix.oneOf([
            envix.read(exports.EnvironmentVariableName.CACHE),
            envix.read(exports.EnvironmentVariableName.CACHE_ALT)
        ])),
        uuidExtension: envix.oneOf([
            envix.read(exports.EnvironmentVariableName.UUID_EXTENSION),
            envix.read(exports.EnvironmentVariableName.UUID_EXTENSION_ALT)
        ])
    };
    if (output.extra) {
    ...
    const envType = envix.oneOf([
        envix.read(exports.EnvironmentVariableName.TYPE),
        envix.read(exports.EnvironmentVariableName.TYPE_ALT)
    ]);
    if (envType) {
        type = envType;
    } else {
...
function createDriver(connectionOptions) {
    ...
    const driverFactory = new DriverFactory.DriverFactory();
...
class GenerateCommand extends MigrationGenerateCommand.MigrationGenerateCommand {
...
function buildTemplate(name, timestamp, upStatements, downStatements) {
    const migrationName = `${pascalCase.pascalCase(name)}${timestamp}`;
...
async function synchronizeDatabaseSchema(input) {
    let dataSource;
    let options;
    if (typeorm.InstanceChecker.isDataSource(input)) {
        dataSource = input;
        options = dataSource.options;
    } else {
        options = input;
        dataSource = new typeorm.DataSource(options);
    }
    if (!dataSource.isInitialized) {
        await dataSource.initialize();
    }
...
async function createPostgresDatabase(context) {
    ...
    if (context.ifNotExist) {
        ...
        if (locter.isObject(existResult) && hasOwnProperty(existResult, 'rows') && Array.isArray(existResult.rows) && existResult.rows.length > 0) {
...
class SeederFactory {
    ...
    async useFaker() {
        ...
        const fakerExports = await locter.load('@faker-js/faker');
        let names;
        if (this.locale) {
        ...
        for(let i = 0; i < names.length; i++){
            if (hasOwnProperty(fakerExports, 'default') && locter.isObject(fakerExports.default) && hasOwnProperty(fakerExports.default, names[i])) {
        ...
        this.faker = new faker.Faker(options);
        return this.faker;
    }
    // --------------------------------------------------------------
    constructor(context){
...
async function resolveFilePatterns(filesPattern, root) {
    return locter.locateMany(filesPattern, {
        ...root ? {
            path: root
        } : {},
        ignore: [
...
async function prepareSeederSeeds(input, root) {
    ...
    if (seedFiles.length > 0) {
        ...
        for(let i = 0; i < seedFiles.length; i++){
            const moduleExports = await locter.load(seedFiles[i]);
...
function buildSeederFileTemplate(name, timestamp) {
    const className = `${pascalCase.pascalCase(name)}${timestamp}`;
...
async function prepareSeederFactories(items, root) {
    ...
    if (factoryFiles.length > 0) {
        ...
        for(let i = 0; i < factoryFiles.length; i++){
            await locter.load(factoryFiles[i]);
        }
    }
...
class SeederExecutor {
    ...
    async track(queryRunner, seederEntity) {
        ...
        if (this.dataSource.driver.options.type === 'mssql') {
            values.timestamp = new typeorm.MssqlParameter(seederEntity.timestamp, this.dataSource.driver.normalizeType({
                type: this.dataSource.driver.mappedDataTypes.migrationTimestamp
            }));
            values.name = new typeorm.MssqlParameter(seederEntity.name, this.dataSource.driver.normalizeType({
                type: this.dataSource.driver.mappedDataTypes.migrationName
            }));
        } else {
    ...
    async buildOptions(input = {}) {
        ...
        if (!this.options.preserveFilePaths) {
            let tsConfig;
            if (locter.isObject(this.options.tsconfig)) {
...
class EntityRelationLookupError extends TypeormExtensionError {
    static notReferenced(relation, columns) {
    ...
    static notFound(relation, columns) {
        return new EntityRelationLookupError({
 ...
 * @param input
 * @param dataSource
 */ async function getEntityMetadata(input, dataSource) {
    if (input instanceof typeorm.Repository) {
        return input.metadata;
    }
    dataSource = dataSource || await useDataSource();
    const index = dataSource.entityMetadatas.findIndex((entityMetadata)=>entityMetadata.target === input);
    if (index === -1) {
 ...
 * @param input
 * @param dataSource
 */ async function getEntityPropertyNames(input, dataSource) {
    let entityMetadata;
    if (input instanceof typeorm.Repository) {
 ...
 * @param entity
 * @param options
 */ async function validateEntityJoinColumns(entity, options) {
    ...
    for(let i = 0; i < entityMetadata.relations.length; i++){
        ...
        for(let j = 0; j < relation.joinColumns.length; j++){
            ...
            if (joinColumn.referencedColumn) {
                ...
                throw EntityRelationLookupError.notReferenced(relation.propertyName, [
        ...
        relations[relation.propertyName] = item;
    }
    const relationKeys = Object.keys(relations);
    for(let i = 0; i < relationKeys.length; i++){
        const relationKey = relationKeys[i];
        entity[relationKey] = relations[relationKey];
    }
    return entity;
}

function transformUndefinedToNull(input) {
    if (typeof input === 'undefined') {
        return null;
    }
    return input;
}
function applyWhereExpression(qb, data, type) {
    const elements = [];
    ...
    for(let i = 0; i < keys.length; i++){
        elements.push({
            ...
            operator: type === 'target' ? rapiq.FilterComparisonOperator.EQUAL : rapiq.FilterComparisonOperator.NOT_EQUAL
        });
    }
 ...
 * @experimental
 * @param options
 */ async function isEntityUnique(options) {
    const dataSource = options.dataSource || await useDataSource();
    ...
    for(let i = 0; i < metadata.ownUniques.length; i++){
        ...
        queryBuilder.where(new typeorm.Brackets((qb)=>{
            applyWhereExpression(qb, pickRecord(options.entity, uniqueColumnNames), 'target');
        }));
        queryBuilder.andWhere(new typeorm.Brackets((qb)=>{
...
exports.DatabaseDropCommand = DatabaseDropCommand;
exports.DriverError = DriverError;
exports.EntityRelationLookupError = EntityRelationLookupError;
exports.OptionsError = OptionsError;
exports.SeedCreateCommand = SeedCreateCommand;
exports.SeedRunCommand = SeedRunCommand;
exports.SeederEntity = SeederEntity;
exports.SeederExecutor = SeederExecutor;
exports.SeederFactory = SeederFactory;
exports.SeederFactoryManager = SeederFactoryManager;
exports.TypeormExtensionError = TypeormExtensionError;
exports.adjustFilePath = adjustFilePath;
exports.adjustFilePaths = adjustFilePaths;
...
exports.buildKeyWithPrefix = buildKeyWithPrefix;
exports.buildSeederFileTemplate = buildSeederFileTemplate;
exports.canReplaceWindowsSeparator = canReplaceWindowsSeparator;
...
exports.getAliasForPath = getAliasForPath;
...
exports.getEntityPropertyNames = getEntityPropertyNames;
...
exports.isEntityUnique = isEntityUnique;
exports.isPromise = isPromise;
exports.isQueryOptionDefined = isQueryOptionDefined;
...
exports.prepareSeederFactories = prepareSeederFactories;
exports.prepareSeederSeeds = prepareSeederSeeds;
exports.readDataSourceOptionsFromEnv = readDataSourceOptionsFromEnv;
exports.readTSConfig = readTSConfig;
exports.replaceWindowSeparator = replaceWindowSeparator;
...
exports.setSeederFactory = setSeederFactory;
exports.synchronizeDatabaseSchema = synchronizeDatabaseSchema;
...
exports.useSeederFactory = useSeederFactory;
exports.useSeederFactoryManager = useSeederFactoryManager;
exports.validateEntityJoinColumns = validateEntityJoinColumns;
