...
class ConfLoader {
    ...
    parse(contents) {
        ...
        for(let i = 0; i < lines.length; i++){
            ...
            const value = destr.destr(match[2].trim());
            if (key.endsWith('[]')) {
    ...
    build(data, options = {}) {
        if (isLocatorInfo(data) || isFilePath(data)) {
            ...
            if (options.withFilePrefix) {
                data = node_url.pathToFileURL(data).href;
            }
        }
        return data;
    }
...
exports.buildLocatorPatterns = buildLocatorPatterns;
...
exports.isTypeScriptError = isTypeScriptError;
exports.load = load;
...
exports.toModuleRecord = toModuleRecord;
